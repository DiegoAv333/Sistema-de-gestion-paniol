export default function DeleteMaterialModal({ material, onCancel, onConfirm }) {
  return (
    <div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50">
      <div className="relative top-20 mx-auto p-5 border w-full max-w-md shadow-lg rounded-md bg-white">
        ...
        <p className="text-sm text-gray-700 mb-6">¿Eliminar <strong>{material.name}</strong> del inventario? Esta acción no se puede deshacer.</p>
